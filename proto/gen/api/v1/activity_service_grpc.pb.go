...
const (
	ActivityService_GetRecentActivity_FullMethodName  = "/monotreme.api.v1.ActivityService/GetRecentActivity"
	ActivityService_GetActivitySummary_FullMethodName = "/monotreme.api.v1.ActivityService/GetActivitySummary"
	ActivityService_ListActivities_FullMethodName     = "/monotreme.api.v1.ActivityService/ListActivities"
)
...
type ActivityServiceClient interface {
	...
	GetActivitySummary(ctx context.Context, in *GetActivitySummaryRequest, opts ...grpc.CallOption) (*GetActivitySummaryResponse, error)
...
func (c *activityServiceClient) GetRecentActivity(ctx context.Context, in *GetRecentActivityRequest, opts ...grpc.CallOption) (*GetRecentActivityResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetRecentActivityResponse)
	err := c.cc.Invoke(ctx, ActivityService_GetRecentActivity_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *activityServiceClient) GetActivitySummary(ctx context.Context, in *GetActivitySummaryRequest, opts ...grpc.CallOption) (*GetActivitySummaryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetActivitySummaryResponse)
	err := c.cc.Invoke(ctx, ActivityService_GetActivitySummary_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ActivityServiceServer interface {
	...
	// GetActivitySummary returns summary statistics for the workspace
	GetActivitySummary(context.Context, *GetActivitySummaryRequest) (*GetActivitySummaryResponse, error)
	// ListActivities returns a paginated list of activities with filtering
...
func (UnimplementedActivityServiceServer) GetRecentActivity(context.Context, *GetRecentActivityRequest) (*GetRecentActivityResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetRecentActivity not implemented")
}
func (UnimplementedActivityServiceServer) GetActivitySummary(context.Context, *GetActivitySummaryRequest) (*GetActivitySummaryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetActivitySummary not implemented")
}
...
func _ActivityService_GetRecentActivity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRecentActivityRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ActivityServiceServer).GetRecentActivity(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ActivityService_GetRecentActivity_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ActivityServiceServer).GetRecentActivity(ctx, req.(*GetRecentActivityRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ActivityService_GetActivitySummary_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetActivitySummaryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ActivityServiceServer).GetActivitySummary(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ActivityService_GetActivitySummary_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ActivityServiceServer).GetActivitySummary(ctx, req.(*GetActivitySummaryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ActivityService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "monotreme.api.v1.ActivityService",
	HandlerType: (*ActivityServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetRecentActivity",
			Handler:    _ActivityService_GetRecentActivity_Handler,
		},
		{
			MethodName: "GetActivitySummary",
			Handler:    _ActivityService_GetActivitySummary_Handler,
		},
		{
