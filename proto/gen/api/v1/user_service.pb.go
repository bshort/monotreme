...
type User struct {
	...
	ProfilePicture string                 `protobuf:"bytes,17,opt,name=profile_picture,json=profilePicture,proto3" json:"profile_picture,omitempty"`
	...
	EditModePreference string `protobuf:"bytes,16,opt,name=edit_mode_preference,json=editModePreference,proto3" json:"edit_mode_preference,omitempty"`
...
func (x *User) GetEditModePreference() string {
	if x != nil {
		return x.EditModePreference
	}
	return ""
}
...
const file_api_v1_user_service_proto_rawDesc = "" +
	"\n" +
	"\x19api/v1/user_service.proto\x12\x10monotreme.api.v1\x1a\x13api/v1/common.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa0\x05\n" +
	"\x04User\x12\x0e\n" +
	...
	"\x0fprofile_picture\x18\x11 \x01(\tR\x0eprofilePicture\x12\x16\n" +
	"\x06locale\x18\n" +
	...
	"\x12auto_generate_name\x18\x0f \x01(\bR\x10autoGenerateName\x120\n" +
	"\x14edit_mode_preference\x18\x10 \x01(\tR\x12editModePreference\"\x12\n" +
