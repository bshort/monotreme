...
export const ActivityShorcutViewPayload: MessageFns<ActivityShorcutViewPayload> = {
  encode(message: ActivityShorcutViewPayload, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.params).forEach(
      ([key, value]: [string, ActivityShorcutViewPayload_ValueList]) => {
  ...
  fromPartial(object: DeepPartial<ActivityShorcutViewPayload>): ActivityShorcutViewPayload {
    ...
    message.params =
      (globalThis.Object.entries(object.params ?? {}) as [string, ActivityShorcutViewPayload_ValueList][]).reduce(
        (
          acc: { [key: string]: ActivityShorcutViewPayload_ValueList },
          [key, value]: [string, ActivityShorcutViewPayload_ValueList],
        ) => {
          if (value !== undefined) {
