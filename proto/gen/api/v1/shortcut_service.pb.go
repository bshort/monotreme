...
type Shortcut struct {
	...
	Visibility    Visibility                  `protobuf:"varint,11,opt,name=visibility,proto3,enum=monotreme.api.v1.Visibility" json:"visibility,omitempty"`
...
func (x *Shortcut) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
func (x *Shortcut) GetUserOrder() int32 {
	if x != nil {
		return x.UserOrder
	}
	return 0
...
func (x *Shortcut) GetIsFavorite() bool {
	if x != nil {
		return x.IsFavorite
	}
	return false
...
type ListShortcutsRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Optional: maximum number of shortcuts to return. Default is 50.
	Limit *int32 `protobuf:"varint,1,opt,name=limit,proto3,oneof" json:"limit,omitempty"`
	// Optional: number of shortcuts to skip. Used for pagination.
...
func (x *ListShortcutsRequest) GetLimit() int32 {
...
func (x *ListShortcutsRequest) GetOffset() int32 {
...
type ListShortcutsResponse struct {
	...
	// Total count of shortcuts (ignoring pagination)
...
func (x *ListShortcutsResponse) GetTotalCount() int32 {
	if x != nil {
		return x.TotalCount
	}
	return 0
...
func (x *ListShortcutsResponse) GetHasMore() bool {
	if x != nil {
		return x.HasMore
	}
	return false
...
type DeleteAllShortcutsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DeleteAllShortcutsRequest) Reset() {
	*x = DeleteAllShortcutsRequest{}
	mi := &file_api_v1_shortcut_service_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DeleteAllShortcutsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeleteAllShortcutsRequest) ProtoMessage() {}

func (x *DeleteAllShortcutsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_shortcut_service_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeleteAllShortcutsRequest.ProtoReflect.Descriptor instead.
func (*DeleteAllShortcutsRequest) Descriptor() ([]byte, []int) {
...
func (*GetShortcutAnalyticsResponse_AnalyticsItem) Descriptor() ([]byte, []int) {
	return file_api_v1_shortcut_service_proto_rawDescGZIP(), []int{10, 0}
}
...
const file_api_v1_shortcut_service_proto_rawDesc = "" +
	"\n" +
	"\x1dapi/v1/shortcut_service.proto\x12\x10monotreme.api.v1\x1a\x13api/v1/common.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x80\x06\n" +
	"\bShortcut\x12\x0e\n" +
	...
	"\btag_info\x18\x0f \x03(\v2\".monotreme.api.v1.Shortcut.TagInfoR\atagInfo\x12\x1f\n" +
	...
	"\x14ListShortcutsRequest\x12\x19\n" +
	...
	"\tshortcuts\x18\x01 \x03(\v2\x1a.monotreme.api.v1.ShortcutR\tshortcuts\x12\x1f\n" +
	...
	"\x05count\x18\x02 \x01(\x05R\x05count2\x96\b\n" +
	...
	"\x0eDeleteShortcut\x12'.monotreme.api.v1.DeleteShortcutRequest\x1a\x16.google.protobuf.Empty\"#\xdaA\x02id\x82\xd3\xe4\x93\x02\x18*\x16/api/v1/shortcuts/{id}\x12t\n" +
	"\x12DeleteAllShortcuts\x12+.monotreme.api.v1.DeleteAllShortcutsRequest\x1a\x16.google.protobuf.Empty\"\x19\x82\xd3\xe4\x93\x02\x13*\x11/api/v1/shortcuts\x12\xa4\x01\n" +
...
var file_api_v1_shortcut_service_proto_goTypes = []any{
	...
	(*ListShortcutsResponse)(nil),                      // 2: monotreme.api.v1.ListShortcutsResponse
	(*GetShortcutRequest)(nil),                         // 3: monotreme.api.v1.GetShortcutRequest
	(*GetShortcutByNameRequest)(nil),                   // 4: monotreme.api.v1.GetShortcutByNameRequest
	(*CreateShortcutRequest)(nil),                      // 5: monotreme.api.v1.CreateShortcutRequest
	(*UpdateShortcutRequest)(nil),                      // 6: monotreme.api.v1.UpdateShortcutRequest
	(*DeleteShortcutRequest)(nil),                      // 7: monotreme.api.v1.DeleteShortcutRequest
	(*DeleteAllShortcutsRequest)(nil),                  // 8: monotreme.api.v1.DeleteAllShortcutsRequest
...
func file_api_v1_shortcut_service_proto_init() {
	...
	file_api_v1_shortcut_service_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
