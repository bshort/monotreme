...
type Collection struct {
	...
	UserOrder     int32                  `protobuf:"varint,12,opt,name=user_order,json=userOrder,proto3" json:"user_order,omitempty"`
...
func (x *Collection) GetUserOrder() int32 {
	if x != nil {
		return x.UserOrder
	}
	return 0
...
const file_api_v1_collection_service_proto_rawDesc = "" +
	"\n" +
	"\x1fapi/v1/collection_service.proto\x12\x10monotreme.api.v1\x1a\x13api/v1/common.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xba\x03\n" +
	"\n" +
	"Collection\x12\x0e\n" +
	...
	"customIcon\x12\x1d\n" +
	"\n" +
	"user_order\x18\f \x01(\x05R\tuserOrder\"\x18\n" +
